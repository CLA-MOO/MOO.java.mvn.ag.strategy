...
### Probar 1 test
```
mvn test -Dtest="AppTest#testLunes"
mvn test -Dtest="AppTest#testMartes"
mvn test -Dtest="AppTest#testMiercoles"
mvn test -Dtest="AppTest#testJueves"
mvn test -Dtest="AppTest#testViernes"
mvn test -Dtest="AppTest#testSabado"
mvn test -Dtest="AppTest#testDomingo" 
```
### Ejecutar App
```
